...
public class ResourceHandler {
	/*
	 * in questa classe bisognerà tenere conto:
	 * degli effetti che danno sia risorse maggiori --> (vedi santa Rita) 
	 * oppure delle scomuniche che tolgono risorse...
	 * 
	 * */
	
	/*
	 * metodo che controlla se il Player ha sufficienti risorse per comprare una carta
	 * invocato da MoveManager per controllare l'acquistabilità
	 * 
	 * --> sarebbe ottimo avere questo metodo in overload per le varie tipologie di carte
	 * 
	 * */
	public boolean enoughResources(DevelopmentCard card, Tower tower){
		//TO-DO
	}
	
	/*
	 * metodo in grado di controllare se la prima risorsa è >= della seconda (true)
	 * */
	 ...
	 * councilPrivilege e permette di scegliere x councilPrivilege diversi, si avrà un ciclo
	 * che permette di scegliere tra le varie possibilità e al ciclo dopo si toglie il
	 * tipo di risorsa già scelto
	 * */
